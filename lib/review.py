...
class Review:
    ...
    def create(cls, year, summary, employee_id):
        ...
        new_review = Review(year=year,summary=summary,employee_id=employee_id)
        new_review.save()
        return new_review
    ...
    def instance_from_db(cls, row):
        ...
        # row is a list [id,year,summary,employee_id]
        ...
        if review:
            ...
            review  = Review(year=row[1],summary=row[2],employee_id=row[3],id=row[0])
